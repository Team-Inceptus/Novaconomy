...
public final class NovaInventory1_18_R2 extends CraftInventoryCustom implements NovaInventory{

    private final Map<String, Object> attributes = new HashMap<>();

    public NovaInventory1_18_R2(String id, String name, int size) {
