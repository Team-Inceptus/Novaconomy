...
public class NBTWrapper1_8_R2 extends NBTWrapper {
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_8_R2.ItemStack.createStack(item));
    }
    ...
    public void set(String key, ItemStack item) {
        ...
        net.minecraft.server.v1_8_R2.ItemStack nms = CraftItemStack.asNMSCopy(item);
