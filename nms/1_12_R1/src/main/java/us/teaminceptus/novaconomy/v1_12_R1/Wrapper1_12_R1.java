package us.teaminceptus.novaconomy.v1_12_R1;
...
import us.teaminceptus.novaconomy.v1_12_R1.NBTWrapper1_12_R1;
import us.teaminceptus.novaconomy.v1_12_R1.NovaInventory1_12_R1;
import us.teaminceptus.novaconomy.v1_12_R1.PacketHandler1_12_R1;
...
final class Wrapper1_12_R1 implements Wrapper {
    ...
    public NBTWrapper createNBTWrapper(org.bukkit.inventory.ItemStack item) {
        return new NBTWrapper1_12_R1(item);
    }
    ...
    public void addPacketInjector(Player p) {
        ...
        ch.pipeline().addAfter("decoder", PACKET_INJECTOR_ID, new PacketHandler1_12_R1(p));
    }
    ...
    public void sendSign(Player p, Consumer<String[]> lines) {
        ...
        PacketHandler1_12_R1.PACKET_HANDLERS.put(p.getUniqueId(), packetO -> {
