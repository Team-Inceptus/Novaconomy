...
public class NBTWrapper1_16_R2 extends NBTWrapper {
    
    public NBTWrapper1_16_R2(ItemStack item) {
        super(item);
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R2.ItemStack.a(productT.getCompound("item")));
