...
final class Wrapper1_20_R4 implements Wrapper {
    ...
    public NovaInventory createInventory(String id, String name, int size) {
        return new NovaInventory1_20_R4(id, name, size);
    }

    @Override
    public NBTWrapper createNBTWrapper(org.bukkit.inventory.ItemStack item) {
        return new NBTWrapper1_20_R4(item);
    }
    ...
    public void addPacketInjector(Player p) {
        ...
        try {
            ...
            ch.pipeline().addAfter("decoder", PACKET_INJECTOR_ID, new PacketHandler1_20_R4(p));
    ...
    public void sendSign(Player p, Consumer<String[]> lines) {
        ...
        PacketHandler1_20_R4.PACKET_HANDLERS.put(p.getUniqueId(), packetO -> {
