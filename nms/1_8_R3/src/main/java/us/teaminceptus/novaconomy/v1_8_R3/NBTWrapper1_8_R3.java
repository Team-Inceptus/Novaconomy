...
public class NBTWrapper1_8_R3 extends NBTWrapper {
    ...
    public NBTWrapper1_8_R3(ItemStack item) {
        super(item);
    }
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_8_R3.ItemStack.createStack(item));
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_8_R3.ItemStack.createStack(productT.getCompound("item")));
    ...
    public void set(String key, Product product) {
        ...
        net.minecraft.server.v1_8_R3.ItemStack nms = CraftItemStack.asNMSCopy(product.getItem());
