package us.teaminceptus.novaconomy.v1_10_R1;
...
public class NBTWrapper1_10_R1 extends NBTWrapper {
    ...
    public NBTWrapper1_10_R1(ItemStack item) {
        super(item);
    }
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_10_R1.ItemStack.createStack(item));
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_10_R1.ItemStack.createStack(productT.getCompound("item")));
    ...
    public void set(String key, Product product) {
        ...
        net.minecraft.server.v1_10_R1.ItemStack nms = CraftItemStack.asNMSCopy(product.getItem());
