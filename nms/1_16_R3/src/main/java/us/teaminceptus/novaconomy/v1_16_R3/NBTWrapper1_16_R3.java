...
public class NBTWrapper1_16_R3 extends NBTWrapper {
    ...
    public NBTWrapper1_16_R3(ItemStack item) {
        super(item);
    }
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R3.ItemStack.a(item));
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R3.ItemStack.a(productT.getCompound("item")));
