package us.teaminceptus.novaconomy.v1_13_R2;
...
public class NBTWrapper1_13_R2 extends NBTWrapper {
    
    public NBTWrapper1_13_R2(ItemStack item) {
        super(item);
    }
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_13_R2.ItemStack.a(item));
    }
    ...
    public void set(String key, ItemStack item) {
        ...
        novaconomy.set(key, CraftItemStack.asNMSCopy(item).save(CraftItemStack.asNMSCopy(item).getOrCreateTag()));
        tag.set(ROOT, novaconomy);
        nmsitem.setTag(tag);
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_13_R2.ItemStack.a(productT.getCompound("item")));
