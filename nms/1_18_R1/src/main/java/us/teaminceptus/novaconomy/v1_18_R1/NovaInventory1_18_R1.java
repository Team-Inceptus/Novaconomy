...
public final class NovaInventory1_18_R1 extends CraftInventoryCustom implements NovaInventory{

    private final Map<String, Object> attributes = new HashMap<>();

    public NovaInventory1_18_R1(String id, String name, int size) {
