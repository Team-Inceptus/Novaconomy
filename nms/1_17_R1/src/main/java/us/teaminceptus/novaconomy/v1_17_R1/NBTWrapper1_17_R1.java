...
public class NBTWrapper1_17_R1 extends NBTWrapper {
    ...
    public NBTWrapper1_17_R1(ItemStack item) {
        super(item);
    }
    ...
    public ItemStack getItem(String key) {
        ...
        return CraftItemStack.asBukkitCopy(net.minecraft.world.item.ItemStack.a(item));
    }
    ...
    public Product getProduct(String key) {
        ...
        ItemStack item = CraftItemStack.asBukkitCopy(net.minecraft.world.item.ItemStack.a(productT.getCompound("item")));
    ...
    public void set(String key, Product product) {
        ...
        if (product instanceof BusinessProduct bp)
            productT.a("business", bp.getBusiness().getUniqueId());
